		...
		<IonPage>
			<IonContent className="ion-padding" fullscreen>
				<IonList>
					<IonItem>
						<IonCheckbox
							checked={props.selectedFilter.includes("blood_pressure")}
							onClick={() => props.setSelectedFilterHandler("blood_pressure")}
							color="danger"
							value="blood_pressure"></IonCheckbox>
					...
					<IonItem>
						<IonCheckbox
							...
							color="primary"
							value="weight"></IonCheckbox>
						<IonLabel style={style.label}>Weight</IonLabel>
					</IonItem>
				</IonList>

				<IonList>
					<IonRadioGroup value={props.selectedDateFilter} onClick={e => props.setSelectedDateFilterHandler(e.target.value)}>
						<IonListHeader>
