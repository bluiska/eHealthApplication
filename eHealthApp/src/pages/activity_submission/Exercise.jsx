		...
		<IonPage>
			...
			<IonContent className="ion-padding">
				...
				<IonItem>
					...
					<IonDatetime display-format="h:mm A" picker-format="h:mm A" placeholder="Select end time"></IonDatetime>
				</IonItem>
				<IonItem>
					<Container>
						<Row style={{ padding: "0px" }}>
							<Col style={{ padding: "0px" }}>
								...
								<IonInput className="ion-no-padding ion-padding-vertical" type="number" placeholder={`Enter the distance ${getType(exerciseType).activity}`} clearInput />
							</Col>
						</Row>
