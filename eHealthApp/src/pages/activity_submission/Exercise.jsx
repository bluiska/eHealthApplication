...
const Exercise = props => {
	...
	const getType = type => {
		switch (type) {
			case "walk":
				return { title: "Walk", activity: "walked", entityType: "walk" };
			case "run":
				return { title: "Run", activity: "ran", entityType: "run" };
			case "cycle":
				return { title: "Cycle", activity: "cycled", entityType: "cycle" };
			default:
				return "";
		}
	};
	...
	const enterDistanceValue = value => {
		if (value <= 10000 && value > 0) {
			...
			if (value) {
				...
				let valMsg = {
					...validationMessage,
					distanceError: value > 10000 ? "The value is too high" : "The value is too low."
				};
